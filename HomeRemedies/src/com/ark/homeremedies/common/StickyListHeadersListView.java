package com.ark.homeremedies.common;
...
import com.ark.homeremedies.common.WrapperViewList.LifeCycleListener;
...
public class StickyListHeadersListView extends FrameLayout {
	...
	private void updateOrClearHeader(int firstVisiblePosition) {
		...
		final boolean isFirstViewBelowTop = doesListHaveChildren && mList.getFirstVisiblePosition() == 0 && mList.getChildAt(0).getTop() > (mClippingToPadding ? mPaddingTop : 0);
		...
		if (mHeaderPosition == null || mHeaderPosition != firstVisiblePosition) {
			...
			if (mHeaderId == null || mHeaderId != headerId) {
				...
				if (mOnStickyHeaderChangedListener != null) {
					mOnStickyHeaderChangedListener.onStickyHeaderChanged(this, mHeader, firstVisiblePosition, mHeaderId);
				}
