package com.ark.homeremedies.main.adapter;
...
public class BrowseAdapter extends ArrayAdapter<Remedie> implements SectionIndexer, StickyListHeadersAdapter {
	...
	public int getPositionForSection(int sectionIndex) {
		...
		for (int i = 0; i < count; i++) {
			if (!TextUtils.isEmpty(getItem(i).getTitle())) {
				char ch = getItem(i).getTitle().toUpperCase(Locale.getDefault()).charAt(0);
	...
	public View getHeaderView(int position, View convertView, ViewGroup parent) {
		TextView view = (TextView) LayoutInflater.from(getContext()).inflate(R.layout.list_item_header_layout, parent, false);
